...
- **Profile views**: How many people viewed your profile this month
- **Follower growth**: Chart of follower count over time
- **Top events**: Which attended events generated the most profile visits

<Note>
  Analytics will be available to users with public profiles only.
</Note>
